...
#write.csv(txi$counts, file = "salmon_counts_raw.csv")
...
#write.csv(rna.design, "/Users/amandan/Desktop/Dworkin/background_effects/data/rna_design.csv")



# Put everything together into a design dataframe 
# 
# rna.design <- data.frame(samples = samples,
#                          background = background,
#                          mutation_type = mutation_type,
#                          lane = lane)
...
# set things up to parallelize the models (ask Arteen about this?)
...
# Add to list
# grab only every other data point for plotting the line
...
# save(PE_plot_df, file = "/scratch/abneves/abneves/outputs/STAR_PEplot_df.Rdata")
